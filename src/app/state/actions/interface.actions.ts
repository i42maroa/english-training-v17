...
export const modalNewTranslation = createAction('[Modal word] new translation');
...
export const modalNewExample = createAction('[Modal word] new example', props<{ translationSel:number}>());
